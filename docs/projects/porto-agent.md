...
## How It Powers This Portfolio

The blog section of this portfolio is partially generated by Porto Agent. Technical articles like "Implementing Orchestrated Agent Workflows" and "Crafting Agent-Based Systems with Graph Orchestration" were drafted by Porto Agent from real commit history, reviewed and approved through the dashboard, and published automatically to GitHub Pages.
